...
from plots_stats.features.plot_panel.plot_classes.base_plot import BasePlot
from plots_stats.features.plot_panel.plot_classes.psd_plot import PSDPlot
from plots_stats.features.plot_panel.plot_classes.linear_plot import LinearPlot
from plots_stats.features.plot_panel.plot_classes.violin_plot import ViolinPlot
from plots_stats.features.plot_panel.plot_classes.scatter_plot import ScatterPlot
from plots_stats.features.plot_panel.plot_classes.erp_plot import ERPPlot
...
class TabbedPlotWidgetController(QtCore.QObject):
    def __init__(self, view):
        super().__init__()
        self.view = view
        self.template_ui_path = 'plots_stats/features/plot_panel/tab_template.ui'
    ...
    def create_tabs(self):
        ...
        if self.view.main_module.is_erp:
            from plots_stats.features.param_selection.flow import filter_files_by_selection
        ...
        params_json, self.plots_json = load_plot_json_files(os.path.dirname(__file__))
        ...
        for idx, param in enumerate(param_iter):
            if param not in self.features_data:
                print(f"[WARN] Parameter '{param}' not found in available_data.json. Skipping.")
                continue
