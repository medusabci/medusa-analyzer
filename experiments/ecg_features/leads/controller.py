...
class LeadsController:
    ...
    def on_show_event(self):
        ...
        """
        if self.from_back:
            # If coming from back button, do not reload
            self.from_back = False
        else:
            # Loading screen
            ...
            files_widget_controller = self.view.main_window.stackedWidget.widget(idx_files_widget).controller # widget(0) is the file selection widget
