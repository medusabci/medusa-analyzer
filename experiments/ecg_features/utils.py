...
def load_config(files_widget, data):
    ...
    preproc_widget = files_widget.main_window.stackedWidget.widget(idx_preprocessing_widget)  # widget(3): preprocessing
    ...
    params_widget = files_widget.main_window.stackedWidget.widget(idx_parameters_widget)  # widget(3): parameters
