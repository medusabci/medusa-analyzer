...
def load_config(files_widget, data):
    ...
    idx_preprocessing_widget = next((i for i, d in enumerate(files_widget.main_window.controller.experiment['pipeline']) if
                                     d.get('widget') == "PreprocessingWidget"))
    preproc_widget = files_widget.main_window.stackedWidget.widget(idx_preprocessing_widget)  # widget(2) is the preprocessing widget
    ...
    idx_segmentation_widget = next((i for i, d in enumerate(files_widget.main_window.controller.experiment['pipeline']) if
                                     d.get('widget') == "SegmentationWidget"))
    segm_widget = files_widget.main_window.stackedWidget.widget(idx_segmentation_widget)  # widget(3) is the segmentation widget
    ...
    params_widget = files_widget.main_window.stackedWidget.widget(idx_parameters_widget)  # widget(4) is the parameters widget
